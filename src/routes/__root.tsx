...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Tumaini Gardens Isinya" },
      { name: "description", content: "Serene lodge & event venue along the Nairobi-Namanga Highway in Kajiado." },
      { name: "author", content: "Emmanuel Ndunda" },
