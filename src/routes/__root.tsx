...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Tumaini Gardens Resort — Isinya, Kajiado · Best Resort in Kenya" },
      { name: "description", content: "Tumaini Gardens Resort in Isinya, Kajiado — accommodation, weddings, conferences & organic farm-to-table dining, 60 km from Nairobi. Book Kenya's serene garden resort." },
      { name: "keywords", content: "Tumaini Gardens Resort, Resort in Kenya, Accommodation in Kenya, Hotel booking Kenya, Vacation resort Kenya, Kajiado resort, Isinya lodge, Nairobi day trip, wedding venue Kenya, conference venue Kajiado, organic farm resort Kenya" },
      ...
      { property: "og:title", content: "Tumaini Gardens Resort — Isinya, Kajiado, Kenya" },
      ...
      { name: "twitter:title", content: "Tumaini Gardens Resort — Kenya" },
    ...
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        "@type": "Resort",
        "@id": "https://tumainigardensresort.co.ke/#resort",
        name: "Tumaini Gardens Resort",
        alternateName: "Tumaini Gardens Isinya",
        description: "Serene garden resort, lodge and event venue 60 km from Nairobi along the Nairobi-Namanga Highway.",
        url: "https://tumainigardensresort.co.ke",
        telephone: "+254759473510",
        priceRange: "KES 7,500 – 22,000",
        image: [
          "https://tumainigardensresort.co.ke/__l5e/assets-v1/ed0bf124-d13d-41f9-8613-78b01b8b9b4e/tumaini-4.jpg",
        ],
        address: {
          "@type": "PostalAddress",
