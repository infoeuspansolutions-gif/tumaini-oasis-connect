      ...
      <header className="border-b border-border/60 bg-card/70 backdrop-blur sticky top-0 z-10">
        <div className="mx-auto max-w-6xl px-5 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 text-sm">
            ...
            <a href="https://tumainigardensresortisinya.co.ke" target="_blank" rel="noreferrer" className="rounded-full border border-border px-3 py-1.5 hover:bg-accent/20">Visit site ↗</a>
